...
const Page = async ({ params: { id } }) => {
  ...
  return (
    <main className="w-full px-4 py-6 sm:px-6 md:px-8 lg:px-12 xl:px-24 text-color-primary bg-[#0f0f0f] min-h-screen">
      {/* Header */}
      ...
      {/* Info Cards */}
      <section className="grid grid-cols-2 sm:grid-cols-5 gap-3 sm:gap-4 md:gap-6 mb-8">
        {[
      ...
      {/* Gambar dan Sinopsis */}
      <section className="flex flex-col lg:flex-row gap-6 mb-10 w-full">
        ...
        <div className="lg:w-2/3 w-full text-justify leading-relaxed text-gray-300 text-base sm:text-lg bg-[#1a1a1a] p-5 rounded-2xl border border-gray-800">
      ...
      <section className="mb-16 mt-12 w-full">
        ...
        <div className="space-y-10 w-full">
          ...
          {user ? (
            <div className="bg-[#111] rounded-2xl p-6 border border-gray-700 w-full">
